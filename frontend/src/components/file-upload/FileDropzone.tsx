                ...
                {tempFile && (
                    <>
                        <button
                            ...
                            className="bg-white text-black px-4 py-2 rounded hover:scale-105 hover:opacity-80 hover:cursor-pointer transition-all duration-100 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        >
                            {isUploading ? (
                                <>
                            ...
                            ) : uploadError ? `Load ${tempFile.name}` : `Load ${tempFile.name}`}
                        </button>
